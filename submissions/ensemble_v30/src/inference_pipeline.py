...
from trainers.multimodal_trainer_v30 import MultimodalTrainerV30
...
if is_kaggle():
    ...
    MODEL_DIR = Path("/kaggle/input/cmi-v30/models")
    PREPROCESSOR_PATH = Path("/kaggle/input/cmi-v30/models/preprocessor.pkl")
else:
