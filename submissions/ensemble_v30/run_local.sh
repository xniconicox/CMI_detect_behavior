...
mkdir -p models
cp ../../output/experiments/20250717_preproc_train_v30/models/multimodal_model_v30_fold*.keras models/
cp ../../output/experiments/20250717_preproc_train_v30/preprocessed/preprocessor.pkl models/
