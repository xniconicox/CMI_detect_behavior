...
# マルチモーダル学習実行スクリプト（v20モデル用）
# 使用方法: ./scripts/run_multimodal_training_v20.sh
...
TRAINER_NAME="multimodal_v20"                              # トレーナー名
MODEL_NAME="multimodal_model_v20"                          # 保存するモデル名
...
if [[ "$SAVE_LOGS" == "true" ]]; then
    ...
    python -c "
import json
from src.trainers.multimodal_trainer_v20 import MultimodalTrainer
...
echo "📖 使用法:"
echo "  変数を変更する場合:"
echo "    EXPERIMENT_NAME=\"your_experiment\" ./scripts/run_multimodal_training_v20.sh"
echo ""
echo "  別の実験を実行する場合:"
echo "    EXPERIMENT_NAME=\"20250713_preproc_pipeline_first_try\" EPOCHS=100 ./scripts/run_multimodal_training_v20.sh"
echo ""
echo "  デバッグ実行する場合:"
echo "    EPOCHS=5 BATCH_SIZE=16 ./scripts/run_multimodal_training_v20.sh"
echo ""