...
# マルチモーダル学習実行スクリプト（v31モデル用）
# 使用方法: ./scripts/run_multimodal_training_v31.sh
...
# 実験設定
EXPERIMENT_NAME="20250717_preproc_train_v31"  # 前処理済みデータの実験名
TRAINER_NAME="multimodal_v31"                              # トレーナー名
MODEL_NAME="multimodal_model_v31"                          # 保存するモデル名
...
echo "📖 使用法:"
echo "  変数を変更する場合:"
echo "    EXPERIMENT_NAME=\"your_experiment\" ./scripts/run_multimodal_training_v31.sh"
echo ""
echo "  別の実験を実行する場合:"
echo "    EXPERIMENT_NAME=\"20250713_preproc_pipeline_first_try\" EPOCHS=100 ./scripts/run_multimodal_training_v31.sh"
echo ""
echo "  デバッグ実行する場合:"
echo "    EPOCHS=5 BATCH_SIZE=16 ./scripts/run_multimodal_training_v31.sh"
echo ""